...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const formData = {
      ...
      second_name: (e.target as any).second_name.value,
      ...
      <div className="h-screen flex max-md:flex-col justify-center items-center content-center w-full">
        ...
        <div className="flex h-2/3 w-1/3 max-md:h-fit max-md:p-5 max-md:w-full bg-black shadow-[0_0_15px_black]">
          ...
          >
            ...
            {error && <div className="bg-red-500 text-white p-2 rounded-md mt-4 w-2/3">{error}</div>}
            {success && <div className="bg-green-500 text-white p-2 rounded-md mt-4 w-2/3">{success}</div>}
